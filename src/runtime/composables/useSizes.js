...
export const useSizes = ( ) => {
    const gridCount = 80;
    const reference = useState('reference', () => { return undefined });
    ...
    const sizes = useState('sizes', () => { return { width:0, height:0, fr: 0 } })
    const scroll = useState('scroll', () => { return { top: 0, left: 0 }});
    ...
    const observer = useState('observer', ()=>{ return null });
    const observerFunctions = useState('observerFunctions', ()=>{ return [] });
